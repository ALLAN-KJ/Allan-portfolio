  ...
  return (
    <section id="competitions" ref={containerRef} className="py-32 w-full bg-[#0A0B0F] overflow-hidden relative">
      <div className="max-w-5xl mx-auto px-6">
        <h2 className="competitions-heading text-[clamp(2.25rem,8vw,3.75rem)] font-black font-heading text-[#EDEDF2] mb-20 text-center tracking-[-0.03em] leading-[0.92]">
        ...
        <div className="flex flex-col gap-16 items-center">
          {competitions.map((comp, idx) => (
            <div
              ...
              className="w-full md:w-[85%] bg-[#0F111A] border border-white/5 rounded-[1.5rem] p-8 md:p-12 shadow-lg relative overflow-hidden group hover:-translate-y-1 hover:border-[#D9A15C]/30 transition-all duration-500 hover:shadow-[0_0_30px_rgba(217,161,92,0.07)] cursor-default"
            >
